function CEndPanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        /* var oSpritebad = s_oSpriteLibrary.getSprite('banner_ad');
        _oIconbad = createBitmap(oSpritebad);
        _oIconbad.regX = oSpritebad.width;
        _oIconbad.regY = oSpritebad.height;
		_oIconbad.x = CANVAS_WIDTH/2 + 150;
        _oIconbad.y = CANVAS_HEIGHT/2 + 400;
        _oGroup.addChild(_oIconbad); */
