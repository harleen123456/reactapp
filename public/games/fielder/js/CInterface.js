function CInterface() {
    ...
    this._init = function () {
        ...
        _pStartPosPause = {x: _pStartPosExit.x - oSprite.height - 5, y: _pStartPosExit.y};
        ...
        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            ...
            _pStartPosAudio = {x: _pStartPosPause.x - oSprite.width/2 - 5, y: _pStartPosExit.y};
            ...
            //oSprite = s_oSpriteLibrary.getSprite('but_fullscreen');
            //_pStartPosFullscreen = {x: _pStartPosPause.x - oSprite.width/2 - 5, y: _pStartPosExit.y};
        }
