function CHelpPanel(iXPos, iYPos, iPlayerTeam, oSprite) {
    ...
    this._init = function (iXPos, iYPos, iPlayerTeam, oSprite) {
        ...
        _oTitle = new createjs.Text(TEXT_HOW_TO_PLAY, "50px " + FONT2, "#ffffff");
        ...
        _oButContinue = new CGfxButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT_HALF + 190, oSpriteContiune, _oGroup);
